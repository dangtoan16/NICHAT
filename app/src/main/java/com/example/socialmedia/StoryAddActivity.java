    ...
    ActivityResultLauncher<Intent> startForResult = registerForActivityResult(
            ...
            result -> {
                if (result.getResultCode() == Activity.RESULT_OK &&
                    ...
                    Toast.makeText(this, "Data is null 78", Toast.LENGTH_SHORT).show();
                    finish();
                }
    ...
    void uploadImageToStorage(String fileName, Uri uri, String type) {
        ...
        storageReference.putFile(uri).addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                Toast.makeText(StoryAddActivity.this, "Error140: " + error, Toast.LENGTH_SHORT).show();
            }
    ...
    void uploadVideoToStorage(String fileName, Uri uri, String type) {
        ...
        storageReference.putFile(Uri.fromFile(file)).addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                assert task.getException() != null;
                String error = task.getException().getMessage();
                Toast.makeText(StoryAddActivity.this, "Error170: " + error, Toast.LENGTH_SHORT).show();
            }
